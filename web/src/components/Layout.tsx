...
export function Layout() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <header className="border-t-4 border-b border-t-accent border-b-line">
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `px-3 py-1.5 text-[0.9375rem] no-underline ${
                    isActive ? "border-b-2 border-accent font-semibold text-accent" : "text-ink hover:text-accent"
                  }`
                }
              >
                {m.label}
      ...
      {sample && (
        <div className="border-b border-warn bg-white" role="note" data-testid="sample-banner">
      ...
      <main className="mx-auto w-full max-w-[1400px] flex-1 px-5 py-4">
        <Outlet />
      </main>
